...
from lib.models.ops.modules import MSDeformAttn
from lib.models.transformer import _get_activation_fn, _get_clones
...
class DeformableTransformer(nn.Module):
    def __init__(self, d_model=256, nhead=8,
        ...
        self.level_embed = nn.Parameter(
            torch.Tensor(num_feature_levels, d_model)) ## 多尺度层级编码

        self.reference_points = nn.Linear(d_model, 2)  ##生成参考点
